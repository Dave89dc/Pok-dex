...
PokéService.getDetail(pokemonName).then(pokemonObject => {
    ...
    const myPokemon = new Pokémon(pokemonObject.name, myPokemonImg);
    myPokemon.height = pokemonObject.height;
    myPokemon.weight = pokemonObject.weight;
